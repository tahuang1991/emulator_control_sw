...
static const char qt_meta_stringdata_RadTestThread[] = {
    "RadTestThread\0\0finished()\0"
};

const QMetaObject RadTestThread::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_RadTestThread,
      qt_meta_data_RadTestThread, 0 }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &RadTestThread::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_RadTestThread))
        return static_cast<void*>(const_cast< RadTestThread*>(this));
